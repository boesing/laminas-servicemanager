...
trait CommonServiceLocatorBehaviorsTrait
{
    ...
    public function methodsAffectedByOverrideSettings(): array
    {
        ...
        return [
            ...
            'configure-lazy-service'    => ['configure', [['lazy_services' => ['class_map' => ['foo' => self::class]]]]],
        ];
    }
     ...
     */
    public function testConsistencyOverInternalStates(ContainerInterface $smTemplate, string $name, array $test, bool $shared)
    {
        $sm              = clone $smTemplate;
        $object['get']   = [];
        $object['build'] = [];
