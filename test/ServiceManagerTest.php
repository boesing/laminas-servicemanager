...
class ServiceManagerTest extends TestCase
{
     ...
     */
    public function testShareability(bool $sharedByDefault, bool $serviceShared, bool $serviceDefined, bool $shouldBeSameInstance)
    {
        $config = [
                ...
                [
                    'abstract_factories' => [
                        new class implements AbstractFactoryInterface {
                             ...
                             */
                            public function canCreate(\Interop\Container\ContainerInterface $container, $requestedName): bool
                            {
